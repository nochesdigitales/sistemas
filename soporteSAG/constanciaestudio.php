			...
			<div class="main-content">
				<div class="main-content-inner">
				  <div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<form action="pdf/inscripcion.php" method="post" enctype="multipart/form-data" name="consulta" target="_blank">
			                  <table width="0" border="0" align="center" cellpadding="4" cellspacing="4">
			                  <tr></tr>
			                  <tr>
			                    <td width="140" class="letra_form">N&uacute;mero de Codigo: </td>
			                    <td width="10"><input name="cedula" type="text" class="input_form" id="cedula"></td>
			                  </tr>
			                  <tr>
			                    <td>&nbsp;</td>
			                    <td><div class="col-md-6">
			                      <button type="submit" class="btn btn-primary" name="Submit" value="Generar Planilla de Inscripcion"> Planilla <i class="fa fa-check"></i> </button>
			                    </div>
			                    <div class="col-md-6">
