<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM facilitador WHERE idfacilitador IN ('" . $d . "')";
...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/rafa.css" />
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
									...
									<form name="form" method="post" action="">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											...
											<tbody>
												...
												?>
												<tr class="odd gradeX">
													<td class="cell-check"><input type="checkbox" class="inbox-checkbox " name="chk" value="<?php echo $fila["idfacilitador"]; ?>"></td>
            							<td><a href="edicionfacilitador.php?i=<?php echo $fila["idfacilitador"] ?>"><?php echo $fila["idfacilitador"] ?></a></td>
													<td><?php echo $fila["nombrefac"] ?></td>
													<td><?php echo $fila["emailfac"] ?></td>
													<td><?php echo $fila["telfac"] ?></td>
							...
							<a class="btn btn-primary" href="edicionfacilitador.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listafacilitador.php')">Borrar</a>
