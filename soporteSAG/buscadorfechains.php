				  ...
				  <div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="row">
     					 ...
     					 <section id="main-content">
							<table width="" border="0" align="center" class="table table-striped table-bordered table-hover dataTable no-footer">
							<?php 
							 // Conexion  
							 include('conexion.php');
							 // Seleccion de la Tabla
							 $consulta = "SELECT * from inscripciones where (fechainsc > '$fechaini') and (fechainsc < '$fechafin')";  
							 ...
							 if(mysql_num_rows($resultado) > 0){
							  ...
							  <!-- Estructura de la Tabla Visible-->
							    ...
							    <td width="80"><div align="center">Cedula</div></td>
							 ...
							 <?php
							  ...
							  <td width="100"><div align="center"><?php echo $row["idinsc"];?></td> 
							  <td width="150"><div align="center"><?php echo $row["periodo"];?></td>
							  <td width="80"><div align="center"><?php echo $row["nombrefac"];?></td>
							  <td width="80"><div align="center"><?php echo $row["cedula"];?></td> 
							  <td width="100"><div align="center"><?php echo $row["nombre"];?></td>
							  <td width="100"><div align="center"><?php echo $row["fechaini"];?></td>
							  </tr> 
							   <?php
							 }
							 }
							...
							<a href="buscadordefechas.php" class="btn btn-info">Regresar</a>
