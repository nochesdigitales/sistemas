<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM cursos WHERE idcurso IN ('" . $d . "')";
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
									...
									<form name="form" method="post" action="">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											...
											<tbody>									
												...
												?>
												<tr class="odd gradeX">
													<td class="cell-check"><input type="checkbox" class="inbox-checkbox " name="chk" value="<?php echo $fila["idcurso"]; ?>"></td>
            							<td><a href="edicioncursos.php?i=<?php echo $fila["idcurso"] ?>"><?php echo $fila["idcurso"] ?></a></td>
							...
							<a class="btn btn-primary" href="edicioncursos.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listacursos.php')">Borrar</a>
