<?php
	...
	if($g == "1") {
		...
		$created_at = $_POST['created_at'];
		 ...
		 $sql = "insert into operation (id, concept, description,  amount, date_at, kind, created_at ) values (null, '$concept', '$description', '$amount', '$date_at', '1', '$created_at')";
		...
		if(mysql_query($sql)) {
				echo '<script>setTimeout(function(){swal({title:"Exito!!!",text:"Ingreso Registrado",type:"success"}, 
													function(isConfirm){location.href="listaingresos.php";});}, 100);</script>';
		}
		else {
		 $sql;
		}
                  ...
                  <div class="form-panel">
                   <div class="module-head">
								...
								<div class="module-body table">
									<form class="form-horizontal row-fluid" action="agregaringresos.php?i=<?php echo $p ?>&g=1" method="post">
									...
									<div class="row">
										...
										<div class="col-md-8">
                                            <select required name="concept" id="concept" class="form-control">
			                                        <option value="1" <?PHP if($concept=='1'){ echo 'selected="selected"'; } ?>>COMPRA DE FILIPINA</option>
			                                        <option value="2" <?PHP if($concept=='2'){ echo 'selected="selected"'; } ?>>PAGO DE CURSO</option>
			                                        <option value="3" <?PHP if($concept=='3'){ echo 'selected="selected"'; } ?>>PAGO DE CERTIFICADO</option>
			                                        <option value="4" <?PHP if($concept=='4'){ echo 'selected="selected"'; } ?>>PAGO DE CARNET</option>
			                                        <option value="5" <?PHP if($concept=='5'){ echo 'selected="selected"'; } ?>>PAGO DE CUOTAS</option>      
                                    		</select>
                               			</div>
										<div class="col-md-4">
										<!-- Espacio -->
									...
									<div class="row">
										...
										<div class="col-md-4">
											<input type="text" id="created_at" name="created_at"  placeholder="Ingresado por" class="form-control round-form" onblur="aMayusculas(this.value,this.id)" value="<?php echo $created_at; ?>">
											</div>
										<div class="col-md-8">
										<!-- Espacio -->
										</div>
									...
									<br>
											...
											Guardar</button>	
											<a href="listaingresos.php" class="btn btn-danger">Regresar</a>										
									</form>
								</div>
							</div><!--/.module-->
