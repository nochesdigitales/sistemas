...
// Seleccion de la Tabla, se pueden usar consultas SQL
 $queEmp = "SELECT * FROM facilitador";
...
// Campos de la Tabla (Tabla) y (Etiquetas)
				'idfacilitador'=>'<b>Cedula</b>',				
				'nombrefac'=>'<b>Facilitador</b>',	
				'emailfac'=>'<b>Email</b>',
				'telfac'=>'<b>Telefono</b>',			
...
// Insertar Texto en el Reporte 
 $pdf->ezText("Reporte de Facilitadores", 12); 
 $pdf->ezText($txttit, 12);
 $pdf->ezTable($data, $titles, '.: Gastronomia :.', $options);
 $pdf->ezText("\n\n\n", 10);
