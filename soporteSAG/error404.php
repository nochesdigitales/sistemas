			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
						<li class="">
								<a href="cursosasignados.php?login_usuario=<?php echo $login_usuario; ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Cursos Asignados
								</a>
...
<li class="">
	...
	Escuela de Gastronomia Dr. Cristobal Mendoza <a href="https://nochesdigitales.com.ve">iutcm</a> (gastronomia).
...
<div class="alert alert-block alert-info">
									...
									Lo sentimos pero la pagina solicitada
								  <strong class="red">
										no existe!
								 
								  </strong>,
	iniciar sesión <a href="index.php">aqui</a> (gastronomia).
	<?php echo "$login_usuario" ?>
								</div>
