<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM operation WHERE id IN ('" . $d . "')";
		$consulta = str_replace(",", "','", $consulta);
		$resultado = mysql_query($consulta);
	}
	
	//Preparar la consulta
	$consulta = "SELECT * FROM operation where kind = '1'"; 
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											...
											<tbody>									
												...
												<tr class="odd gradeX">
													...
													<td><?php echo $fila["concept"] ?></td>
													<td><?php echo $fila["description"] ?></td>
													<td><?php echo $fila["amount"] ?></td>
													<td><?php echo $fila["date_at"] ?></td>
													<td><?php echo $fila["kind"] ?></td>
							...
							<a class="btn btn-primary" href="agregaringresos.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listaingresos.php')">Borrar</a>
