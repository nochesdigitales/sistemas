<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM alumno WHERE cedula IN ('" . $d . "')";
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
									...
									<form name="form" method="post" action="">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											...
											<tbody>									
												...
												?>
												<tr class="odd gradeX">
													<td class="cell-check"><input type="checkbox" class="inbox-checkbox " name="chk" value="<?php echo $fila["cedula"]; ?>"></td>
            							<td><a href="edicionalumnos.php?i=<?php echo $fila["cedula"] ?>"><?php echo $fila["cedula"] ?></a></td>
							...
							<a class="btn btn-primary" href="edicionalumnos.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listaalumnos.php')">Borrar</a>
							<a href="index.php" class="btn btn-danger">Inico</a>
						<br/> 
