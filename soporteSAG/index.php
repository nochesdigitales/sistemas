...
<!-- Final del Menu-->
	...
	Escuela de Gastronomía Dr. Cristóbal Mendoza <a href="https://nochesdigitales.com.ve">iutcm</a> (Gastronomía).
	<?php echo "$login_usuario" ?>
    <a class="fancybox" title="Sistema Automatizado de Gastronomía" data-fancybox-group="works" href="assets/images/logo.png">Acerca de</a>
								</div>
								<div class="row">
									<div class="space-6"></div>
									<div class="vspace-12-sm"></div><!-- /.col -->
								</div><!-- /.row -->
