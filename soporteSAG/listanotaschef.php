<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM nota WHERE idnota IN ('" . $d . "')";
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
									...
									<form name="form" method="post" action="">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											...
											<tbody>
												...
												?>
												<tr class="odd gradeX">
													<td class="cell-check"><input type="checkbox" class="inbox-checkbox " name="chk" value="<?php echo $fila["idnota"]; ?>"></td>
            							<td><a href="edicionnotaschef.php?i=<?php echo $fila["idnota"] ?>"><?php echo $fila["idnota"] ?></a></td>
													<td><?php echo $fila["idcurso"] ?></td>
													<td><?php echo $fila["periodo"] ?></td>
													<td><?php echo $fila["cedula"] ?></td>
													<td><?php echo $fila["nombre"] ?></td>
													<td><?php echo $fila["nota1"] ?></td>
													<td><?php echo $fila["nota2"] ?></td>
													<td><?php echo $fila["nota3"] ?></td>
													<td><?php echo $fila["nota4"] ?></td>
												</tr>
												<?php
												}
												?>
							...
							<a class="btn btn-primary" href="edicionnotaschef.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listanotaschef.php')">Borrar</a>
