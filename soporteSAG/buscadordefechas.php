			...
			<div class="main-content">
				<div class="main-content-inner">
				  <div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<h3>Ingrese el Rango de Fechas a Buscar</h3>
							<form action="buscadorfechains.php" method="get" enctype="multipart/form-data" target="_blank">
							  <center><p>Fecha:</p>
							    <input type="date" placeholder="Fecha Inicial" name="fechaini" />
							    <input type="date" placeholder="Fecha Final" name="fechafin" />
							    <br>
							    <br>
							    <p>
							    <input type="submit" value="Listado" name="boton" class="btn btn-info">
