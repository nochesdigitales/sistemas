<?php
	...
	$consulta = "SELECT * FROM operation where kind = '2'"; 
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="module-head">
							...
							<a class="btn btn-primary" href="agregaregresos.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listaegresos.php')">Borrar</a>
