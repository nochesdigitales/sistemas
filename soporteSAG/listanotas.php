<?php
	...
	if($d != "") {
		$consulta = "DELETE FROM notas WHERE idnota IN ('" . $d . "')";
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%">
											<thead>
												<tr>
													...
													<th>Nombre</th>
													<th>Nota</th>
		idnota, idcurso, nommodulo, idalumno, nombre, notas
												</tr>
											</thead>
											<tbody>									
												<?php
            							...
            							<td><a href="edicionnotas.php?i=<?php echo $fila["idnota"] ?>"><?php echo $fila["idnota"] ?></a></td>
													<td><?php echo $fila["idcurso"] ?></td>
													<td><?php echo $fila["nommodulo"] ?></td>
							...
							<a class="btn btn-primary" href="edicionnotas.php">Nuevo</a>
							<a class="btn btn-primary" href="javascript:remove(this.form, 'listanotas.php')">Borrar</a>
						<br/> 
